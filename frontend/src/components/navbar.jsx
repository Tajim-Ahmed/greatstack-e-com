...
const app = () => {
  ...
  return (
    <div className='flex item-center justify-between py-5 font-medium'>
      <Link to='/' >
    <img src={assets.logo} className='w-36' alt="affa" />
    </Link>
    <ul className='hidden sm:flex gap-5 text-sm text-grey-700' >

      <NavLink to='/' className='flex flex-col item-center gap-1' >
        <p>HOME</p>
        <hr className='w-2/2 item-center border-none h-[1.5px] bg-gray-700 hidden'/>
      </NavLink>

      <NavLink to='/collection' className='flex flex-col item-center gap-1' >
        <p>COLLECTION</p>
        <hr className='w-1/1 item-center border-none h-[1.5px] bg-gray-700 hidden'/>
      </NavLink>
      ...
      {/* <NavLink to='/' className='flex flex-col item-center gap-1' >
        <p>Home</p>
        <hr className='w-2/4 item-center border-none h-[1.5px] bg-gray-700 '/>
      </NavLink> */}
    </ul>
